...
function MaranguRoute() {
    ...
    return (
        <body>
            ...
            <NavbarRest headerProps={{parallaxCaption: 'Mt Kilimanjaro',parallaxTitle: 'Marangu',parallaxImg: "https://res.cloudinary.com/dwxzlruyd/image/upload/v1690679628/kilimaj-hiking/marangu/cover/20220530_121332_hps8a7.jpg"}} />
            <main>

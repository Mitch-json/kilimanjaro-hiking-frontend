    ...
    return (
        <div>
            ...
            <div className="template-wrapper template-wrapper-single-trip single-trips">
                ...
                <div className="jumbotron-wrapper selected-route-jumbotron" style={{backgroundImage: `url('https://res.cloudinary.com/dwxzlruyd/image/upload/v1690679628/kilimaj-hiking/marangu/cover/20220530_121332_hps8a7.jpg')`}}>

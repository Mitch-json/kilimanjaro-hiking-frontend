    ...
    return (
        <div>
            ...
            <div className="template-wrapper template-wrapper-single-trip single-trips">
                ...
                <div className="jumbotron-wrapper selected-route-jumbotron" style={{backgroundImage: `url('https://www.adventurealternative.com/media/817309/northern-circuit-kilimanjaro-camping-trip.jpg')`}}>

...
import RongaiItinerary from '../full-itinerary/RongaiItinerary'
import RongaiExperience from '../the-experience/RongaiExperience'
import RongaiDetails from '../trip-details/RongaiDetails'
import styles from './SelectedRoutes.module.css';

function RongaiRoute() {
    ...
    useEffect(() => {
        ...
        setBookLoading(true)
        fetch(`${process.env.REACT_APP_BACKEND_URL}/trips/rongai`)
    ...
    return (
        <body>
            <Helmet>
                <title>Rongai Route</title>
            </Helmet>
            <NavbarRest headerProps={{parallaxCaption: 'Mt Kilimanjaro',parallaxTitle: 'Rongai',parallaxImg: "https://res.cloudinary.com/dwxzlruyd/image/upload/v1690675968/kilimaj-hiking/rongai/cover/20220531_113502_apdbth.jpg"}} />
            <main>

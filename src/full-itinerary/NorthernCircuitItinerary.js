...
function NorthernCircuitItinerary() {
    return (
        <div className="tab-content">
            <div role="tabpanel" className="tab-pane fade in active" id="the-experience">
                <img src="https://wildwomenexpeditions.com/wp-content/uploads/Tanzania-Day-1-Overlay.png" alt="Arches and Canyonlands Multisport Adventure" className="img-responsive"></img>
...
export default NorthernCircuitItinerary

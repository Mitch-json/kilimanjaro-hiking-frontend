...
function ChogoriaRoute() {
    ...
    return (
        <body>
            <Helmet>
                <title>Chogoria Route</title>
            </Helmet>
            <NavbarRest headerProps={{parallaxCaption: 'Mt Kenya',parallaxTitle: 'Chogoria Route',parallaxImg: "https://res.cloudinary.com/dwxzlruyd/image/upload/v1713905707/kilimaj-hiking/chogoria/cover/PARALLAX-chogoria_ogq8zn.jpg"}} />
            <main>

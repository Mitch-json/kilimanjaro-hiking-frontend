...
import NaroMoruExperience from '../the-experience/NaroMoruExperience'
import NaroMoruItinerary from '../full-itinerary/NaroMoruItinerary'

function NaroMoruRoute() {
    ...
    return (
        <body>
            <Helmet>
                <title>Naro-Moru Route</title>
            </Helmet>
            <NavbarRest headerProps={{parallaxCaption: 'Mt Kenya',parallaxTitle: 'Naro Moru Route',parallaxImg: "https://res.cloudinary.com/dwxzlruyd/image/upload/v1714241225/kilimaj-hiking/naro-moru/PARALLAX-naromoru_ek1kkl.jpg"}} />
            <main>
